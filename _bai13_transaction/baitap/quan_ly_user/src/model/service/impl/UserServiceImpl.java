...
public class UserServiceImpl implements UserService {
    ...
    public List<User> getAllSP() {
        return this.userRepository.getAllSP();
    }

    @Override
    public void editSP(Integer id, String name, String email, String country) {
        this.userRepository.editSP(id,name,email,country);
    }

    @Override
    public boolean deleteSP(Integer id) {

        return this.userRepository.deleteSP(id);
    }
